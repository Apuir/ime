//
// Logging helpers for the libllamacpp JNI bridge.
// Adapted from llama.cpp/examples/llama.android/lib/src/main/cpp/logging.h
//

#ifndef LIBLLAMACPP_LOGGING_H
#define LIBLLAMACPP_LOGGING_H

#endif //LIBLLAMACPP_LOGGING_H

#pragma once
#include <android/log.h>

#ifndef LOG_TAG
#define LOG_TAG "libllamacpp"
#endif

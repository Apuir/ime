package com.ninthsoft.ime.base.llamacpp.internal.gguf

import android.content.Context
import android.net.Uri
import com.ninthsoft.ime.base.llamacpp.gguf.GgufMetadata
import com.ninthsoft.ime.base.llamacpp.gguf.GgufMetadataReader
import com.ninthsoft.ime.base.llamacpp.gguf.InvalidFileFormatException
import java.io.File
...
internal class GgufMetadataReaderImpl(
    ...
    /** Skip a value in the stream without storing it (still maintains pointer). */
    ...
    /** Read an 8-byte little-endian unsigned value and return it as a signed Long. */
    ...
    /** Read a GGUF string from the stream (8-byte length followed by UTF-8 bytes). */
    ...
    /** Convert a 4-byte little-endian byte array to a 32-bit integer. */

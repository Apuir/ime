...
data class CompactColors(
    ...
    @SerialName("bw") val keyBorderWidth: Float = 1f,
    @SerialName("ks") val keyShape: KeyboardColors.KeyShape = KeyboardColors.KeyShape.Rounded,
    @SerialName("g") val geometry: KeyboardColors.KeyGeometry? = null,
